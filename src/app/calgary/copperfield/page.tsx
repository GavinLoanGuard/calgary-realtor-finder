...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://calgaryrealtorfinder.ca/calgary/copperfield',
  },
  openGraph: {
    title: 'Copperfield Calgary Homes for Sale | Calgary Realtor Finder',
    description:
      'Find homes for sale in Copperfield Calgary SE. Get matched with a licensed REALTOR® who specializes in Copperfield real estate. Free, no obligation.',
    ...
    locale: 'en_CA',
    type: 'website',
    images: [{ url: '/og-default.png', width: 1200, height: 630, alt: 'Copperfield Calgary — Calgary Realtor Finder' }],
  },
}
