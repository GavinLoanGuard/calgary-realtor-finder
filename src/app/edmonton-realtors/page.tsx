...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/og-edmonton-realtors.png',
        width: 1200,
        height: 630,
        alt: 'Best Realtors in Edmonton, Alberta — Calgary Realtor Finder',
      },
    ],
  },
}
  ...
  const schema = JSON.stringify([
    ...
    faqSchema([
      ...
      },
      {
        ...
        answer:
          'All Alberta REALTORS® are licensed through the Real Estate Council of Alberta regardless of city. Search the Alberta's public real estate registry by name to verify current license status, brokerage affiliation, and any disciplinary history.',
      },
    ]),
  ])
